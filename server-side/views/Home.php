    ...
    <section class="introduce flex-center">
        <div class="introduce__text container">
            ...
            <p class="mb-5 text--s-black">
                Cada tipo de persona merece unos pinches tacos bien sabrosos apoco no, esto es
                algo único, un incontable número de personas han fallado en casos como 
                los mencionados, por eso se crearon los tacos de carnitas, la mejor creación 
                desde la existencia del hombre, impreshionanti.
            </p>
            <a href="" class="btn">
                LEER MÁS
                <span></span>
    ...
    <section class="events">
        <div class="events__recuerdos">
            ...
            <div class="events__images-item events__images-item--right">
                <img data-src="assets/img/home/kiss.png" alt="" class="image lazyload">
                <picture>
                    <source srcset="assets/img/home/kiss-hq.jpg" media="(min-width: 992px)">
                    <source srcset="assets/img/home/kiss-mq.jpg" media="(min-width: 768px)">
                    <img data-srcset="assets/img/home/kiss-lq.jpg" alt="" class="image lazyload">
                </picture>
            </div>
        </div>
        <div class="events__examples">
            <div class="events__images">
                <div class="events__images-item events__images-item--left">
                    <picture>
                        <source srcset="assets/img/home/slice-of-cake-hq.jpg" media="(min-width: 992px)">
                        <source srcset="assets/img/home/slice-of-cake-mq.jpg" media="(min-width: 768px)">
                        <img data-srcset="assets/img/home/slice-of-cake-lq.jpg" alt="" class="image lazyload">
                    </picture>
                </div>
                <div class="events__images-item events__images-item--center">
                    <picture>
                        <source srcset="assets/img/home/candy-table-hq.jpg" media="(min-width: 992px)">
                        <source srcset="assets/img/home/candy-table-mq.jpg" media="(min-width: 768px)">
                        <img data-srcset="assets/img/home/candy-table-lq.jpg" alt="" class="image lazyload">
                    </picture>
                </div>
            </div>
        ...
        <div class="services__container">
            <div class="services__item">
                <div class="services__item-image">
                    <img id="left-image" data-src="assets/img/home/flower-field-edited.png" alt="" class="image lazyload">
                </div>
                <div class="services__item-info services__item--blue flex-center">
                    <div class="services__item-text">
                        <p class="text--s-black">LO QUE CUBRIMOS</p>
                        <h1 id="service-title" class="services__item-title text--s-black">Bodas</h1>
                ...
                <div class="services__item-image services__item-image--hide-at-small">
                    <img id="right-image" data-src="assets/img/home/give-a-hand.png" alt="" class="image lazyload">
            ...
            <div class="services__item slider--hide">
                ...
                <div class="services__item-info services__item--yellow flex-center">
                    <div class="services__item-text">
                        <p class="text--s-black">LO QUE CUBRIMOS</p>
                        <h1 id="service-title" class="services__item-title text--s-black">XV Años</h1>
                        <p id="service-description" class="text--s-black">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, 
                            sed do eiusmod tempor incididunt ut labore et dolore 
                            magna aliqua. Ut enim ad minim veniam, quis nostrud  
            ...
            <div class="services__item slider--hide">
                ...
                <div class="services__item-info services__item--red flex-center">
                    <div class="services__item-text">
                        <p class="text--s-black">LO QUE CUBRIMOS</p>
                        <h1 id="service-title" class="services__item-title text--s-black">Fiestas</h1>
                        <p id="service-description" class="text--s-black">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, 
                            sed do eiusmod tempor incididunt ut labore et dolore 
                            magna aliqua. Ut enim ad minim veniam, quis nostrud  
            ...
            <div class="services__item slider--hide">
                ...
                <div class="services__item-info services__item--purple flex-center">
                    <div class="services__item-text">
                        <p class="text--s-black">LO QUE CUBRIMOS</p>
                        <h1 id="service-title" class="services__item-title text--s-black">Eventos</h1>
                        <p id="service-description" class="text--s-black">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit, 
                            sed do eiusmod tempor incididunt ut labore et dolore 
                            magna aliqua. Ut enim ad minim veniam, quis nostrud  
